...
build_diagram_duy <- function(map.type) {
  ...
  ggmap(myMap, extent = "device") +
    ...
    labs(x = NULL, y = NULL, title = "Crime Density At UW", size = 15, fill = "Crime Density") +
      theme(plot.title = element_text(color="#666666", face="bold", size=20, hjust=0)) +
      theme(plot.title = element_text(hjust = 0.5))
  ...
  ggmap(myMap) +
    ...
    labs(x = NULL, y = NULL, title = "UW Crime Distribution From 6PM to 6AM (Nighttime)", size = 15) +
    theme(plot.title = element_text(color="#666666", face="bold", size=20, hjust=0)) +
    theme(plot.title = element_text(hjust = 0.5))
  ...
  ggmap(myMap) +
    ...
    labs(x = NULL, y = NULL, title = "UW Crime Distribution From 6AM to 6PM (Daytime)", size = 15) +
    theme(plot.title = element_text(color="#666666", face="bold", size=20, hjust=0)) +
    theme(plot.title = element_text(hjust = 0.5))
  }
}
